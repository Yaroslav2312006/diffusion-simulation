...
Институт информационных технологий и анализа данных, кафедра информационных технологий и систем. 
Группа БИС-24-3.
Студент Соснин Я. Д.
...
pytest tests/
```
Также можно провести тесты через docker:
```bash
docker run -it --rm diffusion-sim pytest tests/
```
